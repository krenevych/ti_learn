...
# ---- параметри сітки ----
WIDTH, HEIGHT = 30, 20           # вузлів по X і Y
W, H = 1.5, 1.2          # розмір «тканини» в світових координатах
...
while window.running:
    ...
    # scene.particles(vertices, radius=0.01, color=(1.0, 0., 0.0))
